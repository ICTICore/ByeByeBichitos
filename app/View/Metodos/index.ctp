                ...
                <div class="panel-bicho-azul panel-default">
                    ...
                    <div class="panel-body-bicho-azul">
                        <ul class="ul-bichos">
                            ...
                            <li>APLICAMOS el acondicionador-eliminador de forma abundante</li>
                            <li>PASAMOS el peine plástico de piojos, hasta que ya no salgan piojos (MUCHAS VECES)</li>
                            <li>PASAMOS el peine liendrera para eliminar los huevecillos o liendres (MUCHAS VECES)</li>
        ...
        <tr>
            ...
            <td style="vertical-align: top; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 40px;">
                <div class="panel-bicho-azul panel-default">
                    ...
                    <div class="panel-body-bicho-azul">
                        <p>Entre 40 y 70 minutos, dependiendo del tipo de infección y del largo y
                        cantidad de cabello.</p>
                    </div>
                </div>
            </td>
            <td style="vertical-align: top; width: 30%; text-align: center; padding-top: 10px; padding-bottom: 10px;">               
                <?php echo $this->Html->image('img_nino.png',array('alt'=>'img','class'=>"img-responsive"));?>
            </td> 
        </tr>
    </table>
</div>